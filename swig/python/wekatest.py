...
filename.setValue_string("art.arff")
...
#------------------------------------
# things to figure wht the hell is going on
instances = pipe.getControl("WekaSource/weka/mrs_natural/nInstances")
...
print "Instances: ", instances.to_natural()
modectl.setValue_string("predict") 
