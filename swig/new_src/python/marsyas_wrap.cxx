...
#define SWIGTYPE_p_std__lessTstd__string_t swig_types[11]
#define SWIGTYPE_p_std__mapTstd__string_MarControlPtr_std__lessTstd__string_t_std__allocatorTstd__pairTstd__string_const_MarControlPtr_t_t_t swig_types[12]
#define SWIGTYPE_p_std__mapTstd__string_MarControlPtr_std__lessTstd__string_t_std__allocatorTstd__pairTstd__string_const_MarControlPtr_t_t_t__allocator_type swig_types[13]
#define SWIGTYPE_p_std__mapTstd__string_MarControlPtr_std__lessTstd__string_t_std__allocatorTstd__pairTstd__string_const_MarControlPtr_t_t_t__mapped_type swig_types[14]
#define SWIGTYPE_p_std__vectorTstd__string_std__allocatorTstd__string_t_t swig_types[15]
#define SWIGTYPE_p_std__vectorTstd__string_std__allocatorTstd__string_t_t__allocator_type swig_types[16]
...
SWIGINTERN PyObject *_wrap_new_Map_String_MarControlPtr__SWIG_0(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "new_Map_String_MarControlPtr" "', argument " "1"" of type '" "std::less<std::string > const &""'"); 
  }
  if (!argp1) {
    SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "new_Map_String_MarControlPtr" "', argument " "1"" of type '" "std::less<std::string > const &""'"); 
  }
  arg1 = reinterpret_cast< std::less<std::string > * >(argp1);
  result = (std::map<std::string,MarControlPtr > *)new std::map<std::string,MarControlPtr >((std::less<std::string > const &)*arg1);
...
SWIGINTERN PyObject *_wrap_new_Map_String_MarControlPtr__SWIG_2(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
...
fail:
  SWIG_SetErrorMsg(PyExc_NotImplementedError,"Wrong number of arguments for overloaded function 'Map_String_MarControlPtr_erase'.\n  Possible C/C++ prototypes are:\n""    erase(std::map<std::string,MarControlPtr > *,std::map<std::string,MarControlPtr >::key_type const &)\n""    erase(std::map<std::string,MarControlPtr > *,std::map<std::string,MarControlPtr >::iterator)\n""    erase(std::map<std::string,MarControlPtr > *,std::map<std::string,MarControlPtr >::iterator,std::map<std::string,MarControlPtr >::iterator)\n");
  return NULL;
}


SWIGINTERN PyObject *_wrap_Map_String_MarControlPtr_find(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::map<std::string,MarControlPtr > *arg1 = (std::map<std::string,MarControlPtr > *) 0 ;
  std::map<std::string,MarControlPtr >::key_type *arg2 = 0 ;
  std::map<std::string,MarControlPtr >::iterator result;
...
SWIGINTERN PyObject *_wrap_Map_String_MarControlPtr_lower_bound(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::map<std::string,MarControlPtr > *arg1 = (std::map<std::string,MarControlPtr > *) 0 ;
  std::map<std::string,MarControlPtr >::key_type *arg2 = 0 ;
  std::map<std::string,MarControlPtr >::iterator result;
...
SWIGINTERN PyObject *_wrap_Map_String_MarControlPtr_upper_bound(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::map<std::string,MarControlPtr > *arg1 = (std::map<std::string,MarControlPtr > *) 0 ;
  std::map<std::string,MarControlPtr >::key_type *arg2 = 0 ;
  std::map<std::string,MarControlPtr >::iterator result;
