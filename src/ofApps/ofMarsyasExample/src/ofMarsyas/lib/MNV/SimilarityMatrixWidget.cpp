...
SimilarityMatrixWidget::SimilarityMatrixWidget(MarSystem *msys, GraphicalEnvironment* env) : MarSystemWidget(msys, env)
{

}

SimilarityMatrixWidget::~SimilarityMatrixWidget()
{
