...
FanOutInWidget::FanOutInWidget(MarSystem *msys, GraphicalEnvironment* env) : MarSystemWidget(msys, env)
{
...
FanOutInWidget::~FanOutInWidget()
{

}


void FanOutInWidget::draw()
{
...
void FanOutInWidget::drawConnections()
{
...
void FanOutInWidget::updateSize()
{
	if(drawChildren_)
	{
		width_ = 0;
...
void FanOutInWidget::updateChildrenWidgets()
{
