...
SilenceRemoveWidget::SilenceRemoveWidget(MarSystem *msys, GraphicalEnvironment* env) : MarSystemWidget(msys, env)
{

}

SilenceRemoveWidget::~SilenceRemoveWidget()
{
