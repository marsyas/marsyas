...
CONFIG(release, debug|release){
	win32-msvc:LIBS 	+= 	marsyas.lib marsyasqt.lib
	!win32-msvc:LIBS = 	-lmarsyas -lmarsyasqt $$LIBS
	LIBPATH += $$quote( \"$$BASEDIR/lib/release\" )
	win32-msvc:PRE_TARGETDEPS += $$quote( \"$$BASEDIR/lib/release/marsyas.lib\" )
	win32-msvc:PRE_TARGETDEPS += $$quote( \"$$BASEDIR/lib/release/marsyasqt.lib\" )
	!win32-msvc:PRE_TARGETDEPS += $$quote( \"$$BASEDIR/lib/release/libmarsyas.a\" )
	!win32-msvc:PRE_TARGETDEPS += $$quote( \"$$BASEDIR/lib/release/libmarsyasqt.a\" )
}
CONFIG(debug, debug|release){
	CONFIGURE	+= console
	win32-msvc:LIBS 	+= 	marsyas.lib marsyasqt.lib
	...
	win32-msvc:PRE_TARGETDEPS += $$quote( \"$$BASEDIR/lib/debug/marsyasqt.lib\" )
	!win32-msvc:PRE_TARGETDEPS += $$quote( \"$$BASEDIR/lib/debug/libmarsyas.a\" )
	!win32-msvc:PRE_TARGETDEPS += $$quote( \"$$BASEDIR/lib/debug/libmarsyasqt.a\" )
}
