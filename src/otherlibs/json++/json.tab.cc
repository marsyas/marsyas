...
static const yytype_uint8 yyprhs[] =
{
      ...
      23,    25,    27,    29,    31,    32,    36,    42,    43,    45
};

/* YYRHS -- A `-1'-separated list of the rules' RHS.  */
static const yytype_int8 yyrhs[] =
{
      16,     0,    -1,    19,    -1,     7,    21,     8,    -1,     5,
      22,     6,    -1,    11,    -1,    12,    -1,    13,    -1,    14,
      -1,    20,    -1,    17,    -1,    18,    -1,     9,    -1,    10,
      -1,    -1,    20,     4,    19,    -1,    21,     3,    20,     4,
      19,    -1,    -1,    19,    -1,    22,     3,    19,    -1
};
...
static const yytype_uint8 yyrline[] =
{
      ...
      75,    76,    80,    88,    98,    99,   105,   113,   114,   119
};
#endif
...
/* Line 1787 of yacc.c  */
#line 61 "json.y"
    { parsd = (yyvsp[(1) - (1)].value_p); }
    break;

  case 3:
/* Line 1787 of yacc.c  */
#line 64 "json.y"
    { (yyval.object_p) = (yyvsp[(2) - (3)].object_p); }
    break;

  case 4:
/* Line 1787 of yacc.c  */
#line 67 "json.y"
    { (yyval.array_p) = (yyvsp[(2) - (3)].array_p); }
    break;

  case 5:
/* Line 1787 of yacc.c  */
#line 70 "json.y"
    { (yyval.value_p) = new JSON::Value((yyvsp[(1) - (1)].int_v)); }
    break;

  case 6:
/* Line 1787 of yacc.c  */
#line 71 "json.y"
    { (yyval.value_p) = new JSON::Value((yyvsp[(1) - (1)].float_v)); }
    break;

  case 7:
/* Line 1787 of yacc.c  */
#line 72 "json.y"
    { (yyval.value_p) = new JSON::Value((yyvsp[(1) - (1)].bool_v)); }
    break;
...
/* Line 1787 of yacc.c  */
#line 74 "json.y"
    { (yyval.value_p) = new JSON::Value(std::move(std::string((yyvsp[(1) - (1)].string_v)))); delete (yyvsp[(1) - (1)].string_v); }
    break;

  case 10:
/* Line 1787 of yacc.c  */
#line 75 "json.y"
    { (yyval.value_p) = new JSON::Value(std::move(*(yyvsp[(1) - (1)].object_p))); delete (yyvsp[(1) - (1)].object_p); }
    break;

  case 11:
/* Line 1787 of yacc.c  */
#line 76 "json.y"
    { (yyval.value_p) = new JSON::Value(std::move(*(yyvsp[(1) - (1)].array_p))); delete (yyvsp[(1) - (1)].array_p); }
    break;
...
#line 80 "json.y"
    {
        // Trim string
        std::string s((yyvsp[(1) - (1)].string_v));
...
#line 99 "json.y"
    {
        (yyval.object_p) = new JSON::Object();
        (yyval.object_p)->insert(std::make_pair(std::string((yyvsp[(1) - (3)].string_v)), std::move(*(yyvsp[(3) - (3)].value_p))));
        delete (yyvsp[(1) - (3)].string_v);
        delete (yyvsp[(3) - (3)].value_p);
    }
    break;
...
#line 105 "json.y"
    { 
        (yyval.object_p)->insert(std::make_pair(std::string((yyvsp[(3) - (5)].string_v)), std::move(*(yyvsp[(5) - (5)].value_p))));
        delete (yyvsp[(3) - (5)].string_v);
        delete (yyvsp[(5) - (5)].value_p);
    }
    break;
...
#line 114 "json.y"
    {
        (yyval.array_p) = new JSON::Array();
        (yyval.array_p)->push_back(std::move(*(yyvsp[(1) - (1)].value_p)));
        delete (yyvsp[(1) - (1)].value_p);
    }
    break;
...
#line 119 "json.y"
    { 
        (yyval.array_p)->push_back(std::move(*(yyvsp[(3) - (3)].value_p))); 
        delete (yyvsp[(3) - (3)].value_p);
    }
    break;
