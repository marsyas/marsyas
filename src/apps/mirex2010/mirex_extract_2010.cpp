...
// mirex_extract
//
// Extract all the SAI/VQ features from the files in
...
void extract(Collection collection, string outWekaName)
{
  ...
  statistics->addMarSystem(mng.create("Sum", "sum"));
  statistics->updControl("Sum/sum/mrs_string/mode", "sum_observations");
