...
CxxTest::StaticSuiteDescription suiteDescription_WekaSource_runner( "TestWekaSource.h", 23, "WekaSource_runner", suite_WekaSource_runner, Tests_WekaSource_runner );
