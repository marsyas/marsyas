...
public:
 TestDescription_Selector_runner_test_all_input_copied_to_output_by_default() : CxxTest::RealTestDescription( Tests_Selector_runner, suiteDescription_Selector_runner, 59, "test_all_input_copied_to_output_by_default" ) {}
...
public:
 TestDescription_Selector_runner_test_disabling_an_observation_should_make_it_not_appear_in_the_output() : CxxTest::RealTestDescription( Tests_Selector_runner, suiteDescription_Selector_runner, 77, "test_disabling_an_observation_should_make_it_not_appear_in_the_output" ) {}
...
public:
 TestDescription_Selector_runner_test_should_be_able_to_disable_and_reenable_an_observation() : CxxTest::RealTestDescription( Tests_Selector_runner, suiteDescription_Selector_runner, 91, "test_should_be_able_to_disable_and_reenable_an_observation" ) {}
