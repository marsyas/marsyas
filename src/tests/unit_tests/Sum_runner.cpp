...
public:
 TestDescription_Sum_runner_test_orig_sum() : CxxTest::RealTestDescription( Tests_Sum_runner, suiteDescription_Sum_runner, 36, "test_orig_sum" ) {}
...
public:
 TestDescription_Sum_runner_test_add_up_observations() : CxxTest::RealTestDescription( Tests_Sum_runner, suiteDescription_Sum_runner, 81, "test_add_up_observations" ) {}
...
public:
 TestDescription_Sum_runner_test_add_up_samples() : CxxTest::RealTestDescription( Tests_Sum_runner, suiteDescription_Sum_runner, 135, "test_add_up_samples" ) {}
...
public:
 TestDescription_Sum_runner_test_add_up_whole() : CxxTest::RealTestDescription( Tests_Sum_runner, suiteDescription_Sum_runner, 189, "test_add_up_whole" ) {}
