...
CxxTest::StaticSuiteDescription suiteDescription_DelaySamples_runner( "TestDelaySamples.h", 15, "DelaySamples_runner", suite_DelaySamples_runner, Tests_DelaySamples_runner );

static class TestDescription_DelaySamples_runner_test_flow_settings : public CxxTest::RealTestDescription {
public:
 TestDescription_DelaySamples_runner_test_flow_settings() : CxxTest::RealTestDescription( Tests_DelaySamples_runner, suiteDescription_DelaySamples_runner, 46, "test_flow_settings" ) {}
...
public:
 TestDescription_DelaySamples_runner_test_process_basic() : CxxTest::RealTestDescription( Tests_DelaySamples_runner, suiteDescription_DelaySamples_runner, 87, "test_process_basic" ) {}
...
public:
 TestDescription_DelaySamples_runner_test_process_one_channel_multiple_slices_small_delay() : CxxTest::RealTestDescription( Tests_DelaySamples_runner, suiteDescription_DelaySamples_runner, 91, "test_process_one_channel_multiple_slices_small_delay" ) {}
...
public:
 TestDescription_DelaySamples_runner_test_process_one_channel_multiple_slices_large_delay() : CxxTest::RealTestDescription( Tests_DelaySamples_runner, suiteDescription_DelaySamples_runner, 96, "test_process_one_channel_multiple_slices_large_delay" ) {}
...
public:
 TestDescription_DelaySamples_runner_test_process_multiple_slices_small_delay() : CxxTest::RealTestDescription( Tests_DelaySamples_runner, suiteDescription_DelaySamples_runner, 101, "test_process_multiple_slices_small_delay" ) {}
...
public:
 TestDescription_DelaySamples_runner_test_process_multiple_slices_large_delay() : CxxTest::RealTestDescription( Tests_DelaySamples_runner, suiteDescription_DelaySamples_runner, 106, "test_process_multiple_slices_large_delay" ) {}
...
public:
 TestDescription_DelaySamples_runner_test_process_multiple_slices_zero_delay() : CxxTest::RealTestDescription( Tests_DelaySamples_runner, suiteDescription_DelaySamples_runner, 111, "test_process_multiple_slices_zero_delay" ) {}
...
public:
 TestDescription_DelaySamples_runner_test_process_negative_delay() : CxxTest::RealTestDescription( Tests_DelaySamples_runner, suiteDescription_DelaySamples_runner, 116, "test_process_negative_delay" ) {}
