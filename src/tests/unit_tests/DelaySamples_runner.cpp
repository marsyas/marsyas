...
public:
 TestDescription_DelaySamples_runner_test_flow_settings() : CxxTest::RealTestDescription( Tests_DelaySamples_runner, suiteDescription_DelaySamples_runner, 60, "test_flow_settings" ) {}
...
public:
 TestDescription_DelaySamples_runner_test_process_basic() : CxxTest::RealTestDescription( Tests_DelaySamples_runner, suiteDescription_DelaySamples_runner, 101, "test_process_basic" ) {}
...
public:
 TestDescription_DelaySamples_runner_test_process_one_channel_multiple_slices_small_delay() : CxxTest::RealTestDescription( Tests_DelaySamples_runner, suiteDescription_DelaySamples_runner, 105, "test_process_one_channel_multiple_slices_small_delay" ) {}
...
public:
 TestDescription_DelaySamples_runner_test_process_one_channel_multiple_slices_large_delay() : CxxTest::RealTestDescription( Tests_DelaySamples_runner, suiteDescription_DelaySamples_runner, 110, "test_process_one_channel_multiple_slices_large_delay" ) {}
...
public:
 TestDescription_DelaySamples_runner_test_process_multiple_slices_small_delay() : CxxTest::RealTestDescription( Tests_DelaySamples_runner, suiteDescription_DelaySamples_runner, 115, "test_process_multiple_slices_small_delay" ) {}
...
public:
 TestDescription_DelaySamples_runner_test_process_multiple_slices_large_delay() : CxxTest::RealTestDescription( Tests_DelaySamples_runner, suiteDescription_DelaySamples_runner, 120, "test_process_multiple_slices_large_delay" ) {}
...
public:
 TestDescription_DelaySamples_runner_test_process_multiple_slices_zero_delay() : CxxTest::RealTestDescription( Tests_DelaySamples_runner, suiteDescription_DelaySamples_runner, 125, "test_process_multiple_slices_zero_delay" ) {}
...
public:
 TestDescription_DelaySamples_runner_test_process_negative_delay() : CxxTest::RealTestDescription( Tests_DelaySamples_runner, suiteDescription_DelaySamples_runner, 130, "test_process_negative_delay" ) {}
