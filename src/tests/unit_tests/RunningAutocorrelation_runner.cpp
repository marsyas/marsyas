...
public:
 TestDescription_RunningAutocorrelation_runner_test_maxlag_larger_than_slice_size() : CxxTest::RealTestDescription( Tests_RunningAutocorrelation_runner, suiteDescription_RunningAutocorrelation_runner, 239, "test_maxlag_larger_than_slice_size" ) {}
...
public:
 TestDescription_RunningAutocorrelation_runner_test_observation_names() : CxxTest::RealTestDescription( Tests_RunningAutocorrelation_runner, suiteDescription_RunningAutocorrelation_runner, 270, "test_observation_names" ) {}
...
public:
 TestDescription_RunningAutocorrelation_runner_test_flow_change() : CxxTest::RealTestDescription( Tests_RunningAutocorrelation_runner, suiteDescription_RunningAutocorrelation_runner, 281, "test_flow_change" ) {}
...
public:
 TestDescription_RunningAutocorrelation_runner_test_normalization() : CxxTest::RealTestDescription( Tests_RunningAutocorrelation_runner, suiteDescription_RunningAutocorrelation_runner, 299, "test_normalization" ) {}
...
public:
 TestDescription_RunningAutocorrelation_runner_test_normalization_of_zero_input() : CxxTest::RealTestDescription( Tests_RunningAutocorrelation_runner, suiteDescription_RunningAutocorrelation_runner, 332, "test_normalization_of_zero_input" ) {}
