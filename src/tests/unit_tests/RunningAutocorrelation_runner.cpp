...
public:
 TestDescription_RunningAutocorrelation_runner_test_output_flow() : CxxTest::RealTestDescription( Tests_RunningAutocorrelation_runner, suiteDescription_RunningAutocorrelation_runner, 88, "test_output_flow" ) {}
...
public:
 TestDescription_RunningAutocorrelation_runner_test_one_slice_single_row() : CxxTest::RealTestDescription( Tests_RunningAutocorrelation_runner, suiteDescription_RunningAutocorrelation_runner, 105, "test_one_slice_single_row" ) {}
...
public:
 TestDescription_RunningAutocorrelation_runner_test_one_slice_multirow() : CxxTest::RealTestDescription( Tests_RunningAutocorrelation_runner, suiteDescription_RunningAutocorrelation_runner, 136, "test_one_slice_multirow" ) {}
...
public:
 TestDescription_RunningAutocorrelation_runner_test_two_slices_single_row() : CxxTest::RealTestDescription( Tests_RunningAutocorrelation_runner, suiteDescription_RunningAutocorrelation_runner, 172, "test_two_slices_single_row" ) {}
...
public:
 TestDescription_RunningAutocorrelation_runner_test_multiple_slices_multirow() : CxxTest::RealTestDescription( Tests_RunningAutocorrelation_runner, suiteDescription_RunningAutocorrelation_runner, 212, "test_multiple_slices_multirow" ) {}
...
public:
 TestDescription_RunningAutocorrelation_runner_test_maxlag_larger_than_slice_size() : CxxTest::RealTestDescription( Tests_RunningAutocorrelation_runner, suiteDescription_RunningAutocorrelation_runner, 243, "test_maxlag_larger_than_slice_size" ) {}
...
public:
 TestDescription_RunningAutocorrelation_runner_test_normalization() : CxxTest::RealTestDescription( Tests_RunningAutocorrelation_runner, suiteDescription_RunningAutocorrelation_runner, 303, "test_normalization" ) {}
...
public:
 TestDescription_RunningAutocorrelation_runner_test_normalization_of_zero_input() : CxxTest::RealTestDescription( Tests_RunningAutocorrelation_runner, suiteDescription_RunningAutocorrelation_runner, 336, "test_normalization_of_zero_input" ) {}
...
public:
 TestDescription_RunningAutocorrelation_runner_test_do_not_normalize_for_lag_0() : CxxTest::RealTestDescription( Tests_RunningAutocorrelation_runner, suiteDescription_RunningAutocorrelation_runner, 359, "test_do_not_normalize_for_lag_0" ) {}
