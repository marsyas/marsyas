...
DeltaFirstOrderRegression::DeltaFirstOrderRegression(string name) : MarSystem("DeltaFirstOrderRegression", name)
{
	/// Add any specific controls needed by this MarSystem.
	addControls();
}

DeltaFirstOrderRegression::DeltaFirstOrderRegression(const DeltaFirstOrderRegression& a) : MarSystem(a)
{
}
...
void
DeltaFirstOrderRegression::addControls()
{
}

void
DeltaFirstOrderRegression::myUpdate(MarControlPtr sender)
{
...
void
DeltaFirstOrderRegression::myProcess(realvec& in, realvec& out)
{
	...
	for (o = 0; o < inObservations_; o++)
	{
		...
		// Update memory
		memory_(o,0) = (inSamples_ >= 2 ? in(o, inSamples_-2) : memory_(o,1));
