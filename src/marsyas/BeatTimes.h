...
#ifndef MARSYAS_BEATTIMES_H
#define MARSYAS_BEATTIMES_H
...
class BeatTimes: public MarSystem
{
private: 
  //Add specific controls needed by this MarSystem.
	void addControls();
	MarControlPtr ctrl_n1stOnsets_;
	MarControlPtr ctrl_accSamples_;
...
public:
  BeatTimes(std::string name);
	BeatTimes(const BeatTimes& a);
  ~BeatTimes();
