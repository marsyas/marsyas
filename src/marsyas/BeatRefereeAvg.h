...
#ifndef MARSYAS_BEATREFEREEAVG_H
#define MARSYAS_BEATREFEREEAVG_H
...
class BeatRefereeAvg: public MarSystem
{
private: 
...
public:
  BeatRefereeAvg(std::string name);
	BeatRefereeAvg(const BeatRefereeAvg& a);
  ~BeatRefereeAvg();
