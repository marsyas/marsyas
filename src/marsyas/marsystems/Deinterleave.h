...
/**  
    ...
    \brief Deinterleave i.e. Reorder input realvec along observations.
			...
			- e.g. there are 8 input rows (i.e. observations)
				then this marsystem would - for three sets (numSets - control set to 3) - reorder the elements of the 8 elements 
