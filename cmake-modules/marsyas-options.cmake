...
if( DEFINED CMAKE_CXX_COMPILER_VERSION )
  ...
  if( CMAKE_CXX_COMPILER_ID MATCHES GNU )
    set(MARSYAS_REQUIRED_COMPILER_VERSION 4.7.0)
  elseif( CMAKE_CXX_COMPILER_ID MATCHES Clang )
    # Apple has own derived Clang, with different versioning
    if(APPLE)
      set(MARSYAS_REQUIRED_COMPILER_VERSION 4.2.0)
    else()
      set(MARSYAS_REQUIRED_COMPILER_VERSION 3.2.0)
    endif()
  elseif( CMAKE_CXX_COMPILER_ID MATCHES MSVC )
    set(MARSYAS_REQUIRED_COMPILER_VERSION 17)
  else()
...
option(WITH_QT5 "Build the Qt5 applications" OFF)
