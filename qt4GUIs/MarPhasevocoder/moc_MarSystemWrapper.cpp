...
int MarSystemWrapper::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: ctrlChanged(*(string*)_a[1],*(MarControlPtr*)_a[2]); break;
        case 1: posChanged(*(int*)_a[1]); break;
        case 2: updctrl(*(string*)_a[1],*(MarControlPtr*)_a[2]); break;
        case 3: { MarControlPtr _r = getctrl(*(string*)_a[1]);
            if (_a[0]) *(MarControlPtr*)_a[0] = _r; }  break;
        case 4: play(); break;
        case 5: pause(); break;
        case 6: run(); break;
        }
